...
img_win = "img/final/thumb.jpg"  # фон победы
img_los = "img/final/game-over.png"  # фон проигрыша
img_back = "img/galaxy/gl1.jpg" # фон игры

img_bullet = "img/base/boom.png"  # пуля
img_hero = "img/sprite/rocket.png"  # герой
img_enemy = "img/sprite/ufo.png"  # враг
...
while run:
    ...
    if not finish:
        ...
        for c in collides:
            ...
            score = score + 1
            monster = Enemy(img_enemy, randint(80, win_width - 80), -40, 80, 50, score * monster_speed)
            monsters.add(monster)
